...
```bash
/compound-docs                    # Document the most recent fix
/compound-docs [brief context]    # Provide additional context hint
```
...
<manual_override> Use /compound-docs [context] to document immediately without waiting for auto-detection. </manual_override> </auto_invoke>
...
- **Manual trigger**: User can invoke agents after /compound-docs completes for deeper review
