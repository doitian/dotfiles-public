...
4. **Source Code Analysis**:
   - Locate installed packages/dependencies in your project
...
1. **Initial Assessment**:
   ...
   - Determine the installed version from lock files or package manifests
...
4. **Source Exploration**:
   - Locate package/dependency source files in node_modules, vendor, or similar directories
