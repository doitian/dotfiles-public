...
- Foundational requirement (core framework, APIs, threading, etc.)
...
Example: For a framework-specific solution:
- Add to `[skill-name]/references/resources.md` under "Project-Specific Resources"
- Add to `[skill-name]/references/examples.md` with link to solution doc
...
**Invoked by:**
- /compound-docs command (primary interface)
