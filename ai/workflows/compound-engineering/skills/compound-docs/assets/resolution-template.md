...
component: [data_model|controller|view|service_object|background_job|database|frontend|api|authentication|payments|development_workflow|testing_framework|documentation|tooling|infrastructure]
symptoms:
...
framework_version: [optional - e.g., 7.1.2]
...
- Affected Component: [e.g., "Email Processing model", "API controller"]
