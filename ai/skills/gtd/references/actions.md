# Next actions and completion

Consider date-specific commitments and follow-ups, then select available work
by context, time available, energy, and importance to the user's goals.
Duration and energy estimates are useful when they change the choice; they
need not become mandatory fields or a universal priority score.
...
is newly available and within the requested maintenance scope, record it;
otherwise surface the decision needed to proceed.

Source: [GTD action selection criteria](https://gettingthingsdone.com/2023/01/choosing-what-to-do/).
