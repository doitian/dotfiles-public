\makeatletter
% Workaround for pandoc/pandoc-crossref bug: captionless longtables
% use \def\LTcaptype{none} but the 'none' counter is not defined.
% See https://github.com/jgm/pandoc/issues/11201
\@ifundefined{c@none}{\newcounter{none}}{}
...
\@ifundefined{KOMAClassName}{}{
  ...
  \renewcommand\newfloat[3]{%
    ...
    \@ifundefined{c@chapter}{}{\setuptoc{#3}{chapteratlist}}%
    \@namedef{ext@#1}{#3}%
    \let\float@do=\relax
