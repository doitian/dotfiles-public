...
def match(name, lang, append):
    ...
    edit = ET.SubElement(el, "edit", name="family", mode="append", binding="strong")
...
for name, spec in C.items():
    ...
    root.append(comment(f'Default {name} when the "lang" attribute is not given'))
    root.append(comment("You can change this font to the language variant you want"))
